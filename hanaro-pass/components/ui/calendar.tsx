  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          'relative inline-flex items-center h-8 px-2 rounded-md border border-input bg-background shadow-sm hover:bg-accent transition-colors',
        ...
        caption_label: cn(
          'select-none font-medium flex items-center gap-1 text-sm h-8 px-2 rounded-md hover:bg-accent transition-colors cursor-pointer',
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          ...
          return (
            <ChevronDownIcon
              className={cn('ml-1 size-4 text-muted-foreground', className)}
              {...props}
            />
          );
        },
