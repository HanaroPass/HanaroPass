export const MARKER_ICONS = {
  ...
  embassy: `
   <div class="w-5 h-5 bg-white rounded-full flex items-center justify-center shadow-[0_2px_5px_rgba(0,0,0,0.2)]">
      <div class="w-4 h-4 bg-blue-100 rounded-full flex items-center justify-center shadow-inner">
  ...
  hospital: `
    <div class="w-5 h-5 bg-white rounded-full flex items-center justify-center shadow-[0_2px_5px_rgba(0,0,0,0.2)]">
      <div class="w-4 h-4 bg-gray-50 rounded-full flex items-center justify-center shadow-inner">
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none"><path d="M9 3H15V9H21V15H15V21H9V15H3V9H9V3Z" fill="#e90061" stroke="#F43F5E" stroke-linejoin="round"/></svg>
      </div>
    </div>`,
