...
export async function postSymptomForm(formData: FormData) {
  ...
  이외의 다른 말은 작성하지마세요. 반드시 아래 형식의 JSON으로 출력해주세요. 설명 문장, 마크다운, 코드블록 없이 순수 JSON만 반환해주세요.
  {
  "주요 증상": string[],
  "발생 시점": string,
...

  {
    ...
    "발생 시점": "2일 전 밤",
    "응급 여부": "낮음",
    "번역 내용": "2일 전 밤부터 발열, 두통 증상이 있습니다. 오늘 4시에 진료 가능할까요? 저는 한국어를 잘 못해요. 아스피린 알레르기가 있어요."
  }
  `;
  const surgeryPrompt = `
